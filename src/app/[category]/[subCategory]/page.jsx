...
//   console.log(params.category); // category param
//   console.log(params.subCategory); // subCategory param
//   console.log(params.product); // product param
  
//   console.log(params.productId); // should be the product ID
//   console.log(params.productName); // should be the product name
