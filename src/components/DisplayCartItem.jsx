...
import Loading from './Loading'; // You can comment this out if using skeletons below
...
const DisplayCartItem = ({ close }) => {
  ...
  const isCartEmpty = !loading && cartItem.length === 0;
  const hasItems = !loading && cartItem.length > 0;
